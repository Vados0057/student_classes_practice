...
public class Test {
    public static void main(String[] args) {
        ...
        */
        ...
        Print how many students are MathStudent with message -> "Math students = {mathClass}"
        Print how many students are ScienceStudent with message -> "Science students = {scienceClass}"
         */
        for (Student listOfStudent : listOfStudents) {
            System.out.println(listOfStudent);
        }
        System.out.println("\nMath students = " + mathClass);
